...
function Sidebar({ handleActive }: any) {
  ...
  const menuItems = [
    { path: '/dashboard', icon: 'dashboards', text: 'Dashboards' },
    { path: '/dashboard/transaction', icon: 'transaction', text: 'Transaction' },
    { path: '/dashboard/statistics', icon: 'statistics', text: 'Statistics' },
    { path: '/dashboard/my-wallet', icon: 'my-wallet', text: 'My Wallet' },
    { path: '/dashboard/integrations', icon: 'integrations', text: 'Integrations' },
    { path: '/dashboard/users', icon: 'user', text: 'User' },
    { path: '/dashboard/history', icon: 'history', text: 'History' },
  ];
  return (
